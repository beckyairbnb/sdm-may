                ...
                <NetlifyFormProvider {...netlify}>
                    ...
                    <NetlifyFormComponent onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="d-flex flex-row mt-8 align-items-center justify-content-center">
                            ...
                            <div className='font-size-6 mb-0'><a href="https://g.page/strategically?share"  className='text-black font-size-6 mb-0' target="_blank" rel="noopener noreferrer">Excellent</a></div>
                            ...
                            <div className='font-size-6 pr-3 mb-0'><a href="https://g.page/strategically?share"  className='text-black font-size-6 mb-0' target="_blank" rel="noopener noreferrer">29 Google Reviews</a></div>
