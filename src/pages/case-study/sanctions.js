            ...
            >
                ...
                <div className="py-12 pt-lg-20 text-size">
                    <div className="container">
                        <div class="row justify-content-center">
                            <div class="col-xl-10 col-12">
                                ...
                                <p> Sanctions.io had a blog where they posted once per month. Unfortunately, they are a team of data and technology buffs, not writers.</p>
                    ...
                    <div className="container">
                        ...
                        <div class="testimonial border p-md-10 p-8 rounded mb-8">
                            <p class="font-size-7 line-height-28 text-dark-cloud m-0">“we cannot pay a huge company; we don't have a huge budget.”</p>
                        </div>
                ...
                <div class="pb-10 text-size">
                    <div className="container">
                        ...
                        <p>Thorsten knew we were the one: “it was just a feeling.” We were more expensive than other agencies he'd tried but offered an affordable pricing plan aligned with his smaller startup budget. Our</p>
                        <div class="testimonial border p-md-10 p-8 rounded mb-8">
                            <p class="font-size-7 line-height-28 text-dark-cloud m-0">
                                “general offering for a small start-up like ours is very attractive from a pricing standpoint.”</p>
                        </div>
                    ...
                    <div className="container">
                        ...
                        <div class="testimonial border p-md-10 p-8 rounded mb-8">
                            <p class="font-size-7 line-height-28 text-dark-cloud m-0">“The process is very easy to work with: good ideas, good content, simple interaction, and a great offering… [It's] very frictionless compared to other experiences that I had.”</p>
                        </div>
                    ...
                    <div className="container">
                        ...
                        <div class="testimonial border p-md-10 p-8 rounded">
                            <p class="font-size-7 line-height-28 text-dark-cloud m-0">“I'm so grateful that we work together, and I am so happy. I'm really super happy!”</p>
                        </div>
                    </div>
                </div>
