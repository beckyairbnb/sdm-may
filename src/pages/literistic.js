                    ...
                    <div className="work_bg py-20">
                        <div className="container">
                            <div className="row">
                                <div className="col-lg-6">
                                    ...
                                    <ul className="p-0">
                                        <li className="d-flex flex-row gap-10 my-2">
                                            <div className="col-lg-2"><span className="worknum">1</span></div>
                                        ...
                                        <li className="d-flex flex-row gap-10 my-2">
                                            <div className="col-lg-2"><span className="worknum">2</span></div>
                                            <div className="col-lg-10 d-flex flex-column">
                                        ...
                                        <li className="d-flex flex-row gap-10 my-2">
                                            <div className="col-lg-2"><span className="worknum">3</span></div>
                                            <div className="col-lg-10 d-flex flex-column">
                                ...
                                <div className="col-lg-6">
                                    <div className="w-100 d-flex items-content-center">
