...
const LeadgenPageMaster = () => {
    ...
    return (
        <>
            ...
            <LeadgenLayout>
                <div className="mb-1">
                    <h2 className="mb-1 font-size-8 letter-spacing-n83">Free industry sample posts</h2>
                    <p className="text-bali-gray font-size-5 mb-0">
                    Tell us about your niche and we'll pull from our plentitude of posts written by Strategically writers.
                    </p>
                </div>
