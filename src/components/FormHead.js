...
const FormHead = ({ step, setActiveStep, handleSubmitBack, handleSubmitRestart }) => {
    return(
        <div className="row justify-content-center text-center my-3 py-1 px-2"> 
            <div className="form-head col-md-12 col-sm-12 col-xl-11 col-lg-12 col-md-12 d-flex justify-content-between m-0 p-0">
                ...
                {step !== 'step1' && <button onClick={handleSubmitBack} className="bg-white border-0 text-end">Back</button>}
                </div>
                ...
                {step !== 'step1' && <button onClick={handleSubmitRestart} className="bg-white border-0 text-end">Restart</button>}
                </div>
            </div> 
          </div>
    )
